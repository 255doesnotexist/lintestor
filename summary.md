...
> 图标说明 Legend: ✅ = 通过 Passed; ⚠️ = 部分或全部测试不通过 Not all tests passed; ❓ = 未知 Unknown

| 软件包 Package | 种类 Type | [debian](#debian) | [bianbu](#bianbu) |
|:------|:------| :-------| :-------|
...
| GNU Compiler Collection | Compiler Toolchain | ⚠️ gcc=14.2.0 | ⚠️ gcc=14.2.0 |
...
| libmemcached | Caching Library | ✅ libmemcached=1.1.4-1.1+b1 | ⚠️ libmemcached=1.1.4-1.1+b1 |
...
| NumPy | Python Library | ✅ numpy=Python 3.12.5 (1.26.4) | ✅ numpy=Python 3.12.5 (1.26.4) |
| Objective Caml | Programming Language | ✅ ocaml=5.0.1-3+b3 | ✅ ocaml=5.0.1-3+b3 |
| OpenJDK Development Kit (JDK) | Java Development Kit | ✅ openjdk=11.0.24 | ✅ openjdk=11.0.24 |
| Perl | Programming Language | ✅ perl=5.38.2 | ✅ perl=5.38.2 |
| Python 3 | Programming Language | ✅ python=3.12.5 | ✅ python=3.12.5 |
| Ruby | Programming Language | ✅ ruby=3.1.2p20 | ✅ ruby=3.1.2p20 |
| Rust | Programming Language | ✅ rust=1.80.1 | ✅ rust=1.80.1 |
| SQLite 3 | Database | ✅ sqlite=3.46.1 | ✅ sqlite=3.46.1 |
| Varnish Cache | Caching Server | ✅ varnish=7.5.0 | ✅ varnish=7.5.0 |
| OpenSSL | Cryptography Library | ✅ openssl=3.3.1 | ✅ openssl=3.3.1 |
| PostgreSQL | Database | ✅ postgresql=16.4 | ✅ postgresql=16.4 |
| Redis | Database | ✅ redis=7.0.15 | ✅ redis=7.0.15 |
| runc | Container Runtime | ⚠️ runc=1.1.12+ds1 | ⚠️ runc=1.1.12+ds1 |
| SciPy | Python Library | ✅ scipy=1.13.1 (python 3.12.5) | ✅ scipy=1.13.1 (python 3.12.5) |
