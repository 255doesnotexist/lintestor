...
|--------|------|------|--------|----------|----------|
| install-toolchain | 安装 PLCT GNU Toolchain | {{ install-toolchain::status.execution }} | {{ install-toolchain::exit_code }} | {{ install-toolchain::stdout }} | {{ install-toolchain::stderr }} |
