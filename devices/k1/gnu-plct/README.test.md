...
| install-toolchain       | Install PLCT GNU Toolchain                    | {{ install-toolchain::status.execution }} | {{ install-toolchain::exit_code }} | {{ install-toolchain::stdout_summary }}  | {{ install-toolchain::stderr_summary }}  |
